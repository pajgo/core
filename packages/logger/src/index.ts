...
import prettyStreamFactory from './streams/pretty'
import sentryStreamFactory from './streams/sentry'
...
export const isCompatible = (obj: any) => {
  return obj !== null
    && typeof obj === 'object'
    && Object.values<any>(exports.levels).every(level => typeof level === 'function')
}
